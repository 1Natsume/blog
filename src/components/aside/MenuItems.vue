    ...
    <div class="menu-items-wrap">
      ...
      <div class="menu-item-area">
        <div v-for="(item, id) in menuList" class="item-row">
          <div :id="'func-item_' + menuIdentify + '_' + id" class="func"
            @click="toggle('func-item_' + menuIdentify + '_' + id)">
...
export default {
  ...
  methods: {
    ...
    toggle(id) {
      $('#'+id+' .bottom').toggleClass('show-bottom-icon')
      $('#'+id+' .children-wrap').toggleClass('active')
    }
    ,
